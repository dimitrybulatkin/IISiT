...
namespace FormNODE
{
    // Класс для заполнения базы знаний узлами со связями
    class Filler
    {
        private static List<Node> nodes; // Список всех узлов
        private static List<Question> questions; // Список всех вопросов

        // Статическая функция для получения списка узлов вместе со связями
        ...
        // Статическая функция для получения заполненого списка с типами связей и названиями вопросов
